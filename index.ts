...
let greeting : string = "Hello, World!";// Declaring a variable named greeting and assigning it a string value "Hello, World!"
...
let num1 : number, num2 : number; // Declaring two variables num1 and num2 of type number
num1 = 10;// Assigning value 10 to num1
num2 = 5;// Assigning value 5 to num2
let sum : number = num1 + num2;// Calculating sum of num1 and num2 // 10 + 5 = 15
let difference : number = num1 - num2;// Calculating difference of num1 and num2 // 10 - 5 = 5
let product : number = num1 * num2;// Calculating product of num1 and num2 // 10 * 5 = 50
let quotient : number = num1 / num2;// Calculating quotient of num1 and num2 // 10 / 5 = 2
...
let a : number = 1, b : number = 2;// Declaring two variables a and b of type number and assigning them values 1 and 2 
...
let remainder : number = num1 % num2;// Calculating remainder of num1 and num2 // 10 % 5 = 0
...
let andGate : boolean = a1 && b1 && c1;// AND gate // true && false && true = false // First the AND gate is applied to a1 and b1 which results in false and then the AND gate is applied to the result of the previous AND gate and c1 which results in false because the associativity of and operator is left to right
let orGate : boolean = a1 || b1 || c1;// OR gate // true || false || true = true // First the OR gate is applied to a1 and b1 which results in true and then the OR gate is applied to the result of the previous OR gate and c1 which results in true because the associativity of or operator is left to right
let notGate : boolean = !a1;// NOT gate // !true = false
...
let num : number = 10; // Declaring a variable num of type number and assigning it a value 10
...
let number : number = 10; // Declaring a variable number of type number and assigning it a value 10
...
let personAge : number = 18; // Declaring a variable personAge of type number and assigning it a value 18
